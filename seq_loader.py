...
class StructureData(Dataset):
    ...
    def process(self):
        ...
        for file in os.listdir(self.raw_dir):
            ...
            # save a data object
            data = Data(x=x, node_attr=node_attrs, edge_index=edges, edge_attr=edge_attr, seq_attr=s)
            print(data)

            torch.save(data, osp.join('/users/rvinod/data/rvinod/tmp/processed', f'data_{idx}.pt'))
...
root = '/users/rvinod/data/rvinod/tmp'
